...
public class GroupDAO {
    ...
    public static Group addGroup(Group group) throws SQLException {
        ...
        if (resultSet.next()) {
            group.setId(resultSet.getInt(1));
            group.setGroupId(resultSet.getInt(2));
            group.setName(resultSet.getString(3));
        }
        return group;
    }

    public static Group read(int groupID) throws SQLException {
        Connection conn = DbUtil.getConnection();
        int idx = 0;
    ...
    public static Group getLastGroupId() throws SQLException {
        Connection conn = DbUtil.getConnection();
    ...
    public static Group loadAllByGrupId(int groupID) throws SQLException {
        Connection conn = DbUtil.getConnection();
        int idx = 0;
    ...
    public static void updateName(Group group, int groupId) throws SQLException {
        Connection conn = DbUtil.getConnection();
        int idx = 0;
    ...
    public static boolean delete(int groupId) throws SQLException {
        Connection conn = DbUtil.getConnection();
        int idx = 0;
