...
public class ExerciseDAO {
    ...
    public Exercise read(int exerciseID) throws SQLException {
        try (Connection conn = DbUtil.getConnection()) {
            int idx = 0;
    ...
    public void update(Exercise exercise, int id) throws SQLException {
        try (Connection conn = DbUtil.getConnection()) {
            int idx = 0;
    ...
    public Exercise getLastExerciseId() throws SQLException {
        try (Connection conn = DbUtil.getConnection()) {
