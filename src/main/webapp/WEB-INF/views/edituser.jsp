...
<h3>Edycja użytkownika ${param.name}</h3>
<table cellpadding="10">
    <form action="userList" method="post">
        <tr><td>Nowa nazwa: </td><td><input type="text" name="name" value="${param.name}" /></td></tr>
        <tr><td>Nowy e-mail: </td><td><input type="email" name="email" value="${param.email}" /></td></tr>
        <tr><td>Nowe hasło: </td><td><input type="password" name="password" /></td></tr>
